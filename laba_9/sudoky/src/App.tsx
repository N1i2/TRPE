...
function convertPositionToIndex(row: number, column: number) {
    ...
    <div className="App">
      ...
      <div className='ControlButton'>
        <div className='Button Check'>
          <button onClick={handleCheck} disabled={disabled}>Chack</button>
        </div>
        <div className='Button Replay'>
          <button onClick={handleReloadPage}>Replay</button>
        </div>
      </div>
    </div>
  );
